...
public class MealsUtil {
    ...
    public static List<MealTo> getFilteredByDateTos(Collection<Meal> meals, int caloriesPerDay, LocalDate startDate, LocalDate endDate) {
        return getFiltered(meals, caloriesPerDay, meal -> DateTimeUtil.isBetweenDate(meal.getDate(), startDate, endDate));
    }
    ...
    public static List<MealTo> getFilteredTos(Collection<Meal> meals, int caloriesPerDay, LocalDate startDate, LocalTime startTime, LocalDate endDate, LocalTime endTime) {
        return getFiltered(meals, caloriesPerDay, meal -> DateTimeUtil.isBetweenTime(meal.getTime(), startTime, endTime) && DateTimeUtil.isBetweenDate(meal.getDate(), startDate, endDate));
    }
